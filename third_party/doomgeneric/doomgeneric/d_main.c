...
void D_DoomLoop (void)
{
    ...
    DG_StartupProgress(96, "Starting game loop");
...
void D_DoomMain (void)
{
    ...
    DG_StartupProgress(14, "Allocating game memory");
    Z_Init ();
    ...
    DG_StartupProgress(22, "Preparing video memory");
    V_Init ();

    // Load configuration files before initialising other subsystems.
    DEH_printf("M_LoadDefaults: Load system defaults.\n");
    DG_StartupProgress(30, "Loading settings");
    ...
    DG_StartupProgress(38, "Locating IWAD");
    ...
    DG_StartupProgress(48, "Reading IWAD");
    D_AddFile(iwadfile);
#if ORIGCODE
...
//    W_PrintDirectory();
    ...
    DG_StartupProgress(62, "Indexing game data");
    W_GenerateHashTable();
    ...
    DG_StartupProgress(72, "Initializing platform");
    ...
    DG_StartupProgress(80, "Loading game data");
    M_Init ();

    DEH_printf("R_Init: Init DOOM refresh daemon - ");
    DG_StartupProgress(87, "Building renderer");
    R_Init ();

    DEH_printf("\nP_Init: Init Playloop state.\n");
    DG_StartupProgress(92, "Preparing play loop");
    P_Init ();
