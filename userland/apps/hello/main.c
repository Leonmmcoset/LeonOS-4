...
static void draw_hello(struct leonos_ui_surface *ui, uint32_t hover)
{
    ...
    leonos_ui_text(ui, 22, 26, "Hello from hello.elf", LEONOS_UI_BLACK, LEONOS_UI_LIGHT);
    leonos_ui_text(ui, 22, 50, "This window is rendered by the app", LEONOS_UI_DARK, LEONOS_UI_LIGHT);
    leonos_ui_button(ui, 22, 88, 88, LEONOS_UI_BUTTON_H, "Hello",
                     hover ? LEONOS_UI_BUTTON_PRESSED : 0);
    leonos_ui_text(ui, 124, 92, hover ? "Button pressed" : "Window server v2", LEONOS_UI_BLACK, LEONOS_UI_LIGHT);
}
