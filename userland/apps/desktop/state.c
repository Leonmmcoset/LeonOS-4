...
uint8_t desktop_lifecycle_state;
uint8_t desktop_lifecycle_action;
uint8_t desktop_lifecycle_force_requested;
unsigned long desktop_lifecycle_started_ms;
uint32_t desktop_lifecycle_target_count;
uint32_t desktop_lifecycle_remaining_count;
uint32_t desktop_lifecycle_pids[DESKTOP_LIFECYCLE_MAX_TARGETS];
